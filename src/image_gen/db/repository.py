...
from image_gen.models import GenerationResponse, GenerationStatus
    ...
    *,
    ...
    await db.execute(
        ...
        INSERT INTO generations
            (id, user_id, name, prompt, aspect_ratio, resolution, status, created_at)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        """,
        (generation_id, user_id, name, prompt, aspect_ratio, resolution, "pending", now),
    )
    await db.commit()
